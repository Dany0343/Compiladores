...
from comp.ast import Identifier, LetStatement, Program, Statement
...
class Parser:
    ...
    def _parse_let_statement(self) -> Optional[LetStatement]:
        ...
        while self._current_token.token_type != TokenType.NEWLINE and self._current_token.token_type != TokenType.EOF:
            self._advance_tokens()

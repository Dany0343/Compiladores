...
# @generated by pegen from /home/dany0343/dev/Compiladores/grammar.gram
...
class PythonParser(Parser):
    ...
    KEYWORDS = ('continue', 'def', 'return', 'class', 'or', 'try', 'break', 'True', 'await', 'yield', 'as', 'else', 'lambda', 'if', 'None', 'with', 'finally', 'while', 'del', 'except', 'and', 'elif', 'pass', 'raise', 'async', 'for', 'global', 'from', 'in', 'not', 'assert', 'False', 'is', 'import', 'nonlocal')
